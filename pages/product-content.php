...
<body class="g-sidenav-show  bg-gray-200">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="font-weight-bolder mb-0">商品詳細資訊</h6>
                </nav>
            </div>
        </nav>
        <!-- End Navbar -->
        ...
        <!-- 新增商品頁面 -->
        <div class="container">
            <h2 class="text-center my-3">商品詳細資訊</h2>
            ...
            <a class="btn-sm-edit btn-warning my-2 ms-4" href="product-edit.php?id=<?= $_GET["id"] ?>">
                            ...
                            <table class="table-bordered table-bs5 my-4">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="row">
                                            <div class="col">
                                                <select name="productClass" id="setClass" class="form-select-bs5" aria-label="Default select example" value="<?= $row["class"] ?>" required disabled>
                                            ...
                                            <div class="col">
                                                <select value="" name="productOther" id="setOther" class="form-select-bs5" aria-label="Default select example" required disabled>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="row">
                                            <div class="col">
                                                <select value="" name="productColor[]" id="setColor" class="form-select-bs5" aria-label="Default select example" multiple disabled>
                                                    <option selected>請選擇顏色</option>

                                                </select>
                                            </div>
                                            <div class="col">
                                                <select value="" name="productSize[]" id="setSize" class="form-select-bs5" aria-label="Default select example" required multiple disabled>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select value="" name="productBrand" id="setBrand" class="form-select-bs5" aria-label="Default select example" required disabled>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-floating">
                                            <textarea name="productDescription" class="form-control-bs5  add-text-area" placeholder="請輸入商品描述" id="floatingTextarea2" disabled><?= $row["description"] ?></textarea>
