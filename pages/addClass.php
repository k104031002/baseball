    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        ...
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder mb-0">新增主類別</h6>
        </nav>
      </div>
    </nav>
    <div class="container">
      ...
      <form action="add_class.php" method="post">
        <div class="my-3 page2_PJ-title">
          <h2 class="text-center">新增主類別</h2>
        </div>

        <div class="location page2_PJ-inputbox  align-content-center">
          <input type="text" name="name" class="page2_PJ-input form-control" placeholder="請輸入主類別名稱">
