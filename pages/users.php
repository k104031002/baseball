...
if (isset($_GET["order"])) {
  ...
  if ($order == 1) {
    ...
    $orderString = "ORDER BY account ASC";
  } elseif ($order == 4) {
    $orderString = "ORDER BY account DESC";
  }
}
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        ...
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder mb-0">會員列表</h6>
        </nav>
      </div>
    </nav>
    <div class="container">
      <h2 class="d-flex justify-content-center
    align-items-center">會員列表</h2>
      <div class="py-2">
        <div class="row g-3">
          <?php if (isset($_GET["search"])) : ?>
            <div class="col-auto">
              <a name="" id="" class="btn btn-primary searchback" href="users.php" role="button"><i class="fa-solid fa-reply fa-fw"></i></a>
            </div>
          <?php endif; ?>
          <div class="col">
            <form action="">
              <div class="input-group mb-3">
                ...
                <button class="btn btn-primary" type="submit" id="button-addon2"><i class="fa-solid fa-magnifying-glass fa-fw"></i>搜尋</button>
              </div>
            </form>
          </div>
        </div>
      ...
      <div class="d-flex justify-content-between pb-2 align-items-center">
        ...
        <div>
          <a name="" id="" class="btn btn-primary" href="addUser.php" role="button"><i class="fa-solid fa-user-plus"></i></a>
        </div>
      </div>
      <div class="py-2 justify-content-end d-flex align-items-center">
        <div class="me-2">排序</div>
        <div class="btn-group ">
          <a class="btn btn-primary <?php if ($order == 1) echo "active" ?>" href="users.php?order=1&p=<?= $p ?>"><i class="fa-solid fa-arrow-up-1-9 fa-fw"></i>id </a>
          <a class="btn btn-primary <?php if ($order == 2) echo "active" ?>" href="users.php?order=2&p=<?= $p ?>"><i class="fa-solid fa-arrow-down-9-1 fa-fw"></i>id </a>
          <a class="btn btn-primary <?php if ($order == 3) echo "active" ?>" href="users.php?order=3&p=<?= $p ?>">account <i class="fa-solid fa-arrow-up-a-z fa-fw"></i></a>
          <a class="btn btn-primary <?php if ($order == 4) echo "avtie" ?>" href="users.php?order=4&p=<?= $p ?>">account <i class="fa-solid fa-arrow-down-z-a fa-fw"></i></a>
        </div>
      </div>
      <?php
      if ($userCount > 0) :
          ...
          <tbody>
            ...
            ?>
              <tr>
                ...
                <td><?= $user["address"] ?></td>
                <td><?= $user["created"] ?></td>
                <td><a class="btn btn-warning" href="user.php?id=<?= $user["id"] ?>" role="button"><i class="fa-solid fa-address-book fa-fw"></i></a>
                </td>
              </tr>
            <?php endforeach; ?>
          </tbody>
