...
<body class="g-sidenav-show  bg-gray-200">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        ...
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder mb-0">文章內容</h6>
        </nav>
      </div>
    </nav>
    ...
    <div class="container">
      <div class="py-2">
        <a class="btn btn-primary searchback" href="article.php" role="button"><i class="fa-solid fa-chevron-left"></i>回文章列表</a>
      </div>
      ...
      ?>
        ...
        <div><img class="mb-3" src="../assets/img/article_img/<?= $rows["photo"] ?>" alt=""></div>
        <div><?= $rows["description"] ?></div>


        <div class="py-2 text-center my-5">
          <a class="btn btn-warning me-5" href="edit_article.php?id=<?= $rows["id"] ?>" role="button">編輯</a>

          <button data-bs-toggle="modal" data-bs-target="#confrimModal" class="btn btn-danger">
            刪除
          </button>
        </div>
      <?php endif; ?>
