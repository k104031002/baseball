...
$sql = "SELECT * FROM product WHERE id=$id AND valid=1 ORDER BY id ASC";
...
<body class="g-sidenav-show  bg-gray-200">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="font-weight-bolder mb-0">修改商品</h6>
                </nav>
            </div>
        </nav>
        <!-- End Navbar -->
        ...
        <!-- 新增商品頁面 -->
        <div class="container">
            <h2 class="text-center my-3">修改商品</h2>

            <a class="btn-back btn-danger my-2 ms-5" href="product-list.php">
                <i class="fa-solid fa-share-from-square fa-flip-horizontal"></i> 取消修改
            </a>
            <a class="btn-sm-edit btn-primary my-2 ms-4" href="product-content.php?id=<?= $_GET["id"] ?>">
            ...
            <div class="row">
                ...
                ?>
                    ...
                    <div class="col-9">
                        <form class="add-form-w" action="updateProduct.php" method="post" enctype="multipart/form-data">
                            ...
                            <table class="table-bordered table-bs5 my-4">
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" class="form-control-bs5" id="productName" name="productName" value="<?= $row["name"] ?>" required></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="row">
                                            <div class="col">
                                                <select name="productClass" id="setClass" class="form-select-bs5" aria-label="Default select example" value="<?= $row["class"] ?>" required>
                                            ...
                                            <div class="col">
                                                <select value="" name="productOther" id="setOther" class="form-select-bs5" aria-label="Default select example" required>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="row">
                                            <div class="col">
                                                <select value="" name="productColor[]" id="setColor" class="form-select-bs5" aria-label="Default select example" required multiple>
                                                    <option selected>請選擇顏色</option>

                                                </select>
                                            </div>
                                            <div class="col">
                                                <select value="" name="productSize[]" id="setSize" class="form-select-bs5" aria-label="Default select example" required multiple>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select value="" name="productBrand" id="setBrand" class="form-select-bs5" aria-label="Default select example" required>
                                ...
                                <tr>
                                    ...
                                    <td><input name="productPrice" type="text" class="form-control-bs5" id="productPrice" name="productPrice" value="<?= $row["price"] ?>" required></td>
                                </tr>
                                <tr>
                                    <th class="add-table-secondary">商品描述 : </th>
                                    <td>
                                        <div class="form-floating">
                                            <textarea name="productDescription" class="form-control-bs5  add-text-area" placeholder="請輸入商品描述" id="floatingTextarea2"><?= $row["description"] ?></textarea>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="input-group mb-3">
                                            ...
                                            <input name="productImage" type="file" class="form-control-bs5" id="inputGroupFile01" value="<?= $row["image_url"] ?>">
    ...
    <?php
    include("../assets/js/edit_js_yu.php");
    ?>
