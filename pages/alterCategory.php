    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        ...
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder mb-0">類別編輯</h6>
        </nav>
      </div>
    </nav>
    <div class="container ">
      ...
      ?>
        ...
        <h2 class="mt-2 text-center">類別編輯頁面</h2>

        <a href="detail.php?id=<?= $row["ID"] ?>" class="searchback position-relative"><i class="fa-solid fa-fw page3-fa-circle-left fa-circle-left"></i></a>
        <form action="alter_other.php" method="post">
          <table class="table table-bordered">
            <input type="hidden" name="id" value="<?= $row["ID"] ?>">
            <table class="table table-bordered table-striped page3_PJ-table">
              <tr>
                <th class="page3_PJ-th">ID</th>
                <td class=""><?= $row["ID"] ?></td>
              </tr>
              <tr>
                <th class="page3_PJ-th">主類別</th>
                <td><input type="text" class="form-control" value="<?= $row["class"] ?>" name="class"></td>
              </tr>
              <tr>
                <th class="page3_PJ-th">子類別</th>
                <td><input type="text" class="form-control" value="<?= $row["other"] ?>" name="other"></td>
              </tr>
              <tr>
                <th class="page3_PJ-th">尺寸</th>
                <td><input type="text" class="form-control" value="<?= $row["size"] ?>" name="size"></td>
              </tr>
              <tr>
                <th class="page3_PJ-th page3_PJ-brand">品牌</th>
                </th>

                <td class="">
                  <textarea class="page3_PJ-text form-control" rows="3" cols="100" name="brand"><?= trim($row["brand"]) ?></textarea>
                </td>
              </tr>
              <tr>
                <th class="page3_PJ-th">顏色</th>
                <td><input type="tel" class="form-control" value="<?= $row["color"] ?>" name="color"></td>
              </tr>
            </table>
            <div class="page3_PJ-btn">
