...
if (isset($_GET["cate"]) && isset($_GET["p"]) && isset($_GET["order"])) {
  ...
  $sql = "SELECT * FROM article WHERE type_id LIKE '%$cate%' AND valid=1  $orderString LIMIT $startIndex, $perPage  ";
}
//篩選加分頁
...
<body class="g-sidenav-show  bg-gray-200">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="container">
      <h2 class="articletitle"><i class="fa-solid fa-baseball-bat-ball"></i>文章列表頁<i class="fa-solid fa-baseball"></i></h2>
      ...
      <div class="py-2">
        <div class="row g-3">
          <?php if (isset($_GET["search"])) : ?>
            <div class="col-auto">
              <a name="" id="" class="btn btn-primary searchback" href="article.php" role="button"><i class="fa-solid fa-arrow-left fa-fw"></i></a>
            </div>
          <?php endif; ?>
        ...
        <tbody>
          ...
          ?>
            <tr>
              ...
              <td class="articlebox multiline-ellipsis" style="white-space: normal; text-align: center;"><?= $article["description"] ?></td>
