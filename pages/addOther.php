    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      <ul class="navbar-nav accordion" id="accordionExample">
        ...
        <li class="nav-item accordion-item">
          <!-- 超連結 -->
          <div class="accordion-header">
            <button class="nav-link text-white accordion-button collapsed active bg-gradient-primary" type="button" data-bs-toggle="collapse" data-bs-target="#collapse4" aria-expanded="false" aria-controls="collapse4">
      ...
      <div class="container-fluid py-1 px-3">
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">商品類別</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">新增類別細項</h6>
        </nav>
      </div>
    </nav>
    <div class="container">
      ...
      <h2 class="mt-3 mb-2 text-center">新增類別細項</h2>

      <div class="mb-2"><a href="category_all.php" class="searchback position-relative">
        ...
        <div class="table-responsive">
          <table class="table table-bordered table-striped">
            <tr>
              ...
              <td><select id="" name="classValue" required class="form-control">
            ...
            <tr>
              ...
              <td>
                <input type="text" id="otherValue" name="otherValue" placeholder="使用,號區分不同規格" required class="form-control">
              </td>
            </tr>
            <tr>
              <th><label for="sizeValue">尺寸</label></th>
              <td><input type="text" id="sizeValue" name="sizeValue" placeholder="使用,號區分不同尺寸" required class="form-control"></td>
            </tr>
            <tr>
              <th><label for="brandValue">品牌</label></th>
              <td>
                <div class="row">
                  <div class="col-3"> <input type="checkbox" id="brandValue" name="brandValue[]" value="MIZUNO"> MIZUNO<br>
                  ...
                  <div class="col-3"><input type="checkbox" id="brandValue" name="brandValue[]" value="EASTON"> EASTON<br>
                  ...
                  <div class="col-3"><input type="checkbox" id="brandValue" name="brandValue[]" value="adidas"> adidas<br>
          ...
          <div class="page4_PJ-btn">
            ...
            <button type="reset" class="btn btn-reset btn-danger mb-4">清空</button>
            <div></div>
            <div></div>
            <div></div>
