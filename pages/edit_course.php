            ...
            <form action="updateCourse.php" method="post" enctype="multipart/form-data">
              ...
              <table class="table table-bordered">
                ...
                <tr>
                  ...
                  <td class="row">
                    <div class="col-6">
                      <input type="datetime-local" class="form-control" value="<?= $row["course_start"] ?>" name="course_start">
                    </div>
                    <div class="col-6">
                      <input type="datetime-local" class="form-control" value="<?= $row["course_end"] ?>" name="course_end">
                    </div>
                  </td>
              ...
              <div class="pb-2 hstack  justify-content-center">
                <div class="mb-5 me-5">
