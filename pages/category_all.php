    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        ...
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder mb-0">類別列表</h6>
        </nav>
      </div>
    </nav>
    <div class="container">
      <!-- CODE貼這裡~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
      <h2 class="text-center">類別列表</h2>
      <div class="py-2">
        <div class="row g-3">
          <?php if (isset($_GET["search"])) : ?>
            <div class="col-auto">
              <a href="category_all.php" class="btn btn-primary searchback" role="button"><i class="fa-solid fa-arrow-left fa-fw"></i></a>
            </div>
          <?php endif; ?>
      ...
      <?php if ($totalCount > 0) : ?>
        <table class="table table-bordered page1_PJ table-striped page1-hover">
          <thead>
            <tr>
              <th>ID</th>
              <th>主類別</th>
          ...
          <tbody>
            ...
            foreach ($rows as $row) : ?>
              <tr>
                ...
                <td class="col data-column">
                  <div class="page1_PJ-icon">
                    <div><a href="alterCategory.php?id=<?= $row["ID"] ?>">
                        <i class="fa-solid fa-pen-to-square fa-fw"></i>
                      </a>
                    </div>

                    <div><a href="delate.php?id=<?= $row["ID"] ?>">
                        <i class="fa-solid fa-trash" style="color: #ff0a0a;"></i></a>
                    </div>
                  </div>
