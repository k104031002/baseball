...
<body class="g-sidenav-show  bg-gray-200">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        ...
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder mb-0">詳細資料</h6>
        </nav>
      </div>
    </nav>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <a role="button" class="btn btn-danger" href="doDeleteUser.php?id=<?= $row["id"] ?>">確認</a>
          </div>
        </div>
      </div>
    </div>
    <div class="container">
      ...
      ?>
        <div class="py-2">
          <a class="btn btn-secondary searchback" href="users.php" role="button"><i class="fa-solid fa-house-chimney-user fa-fw"></i>回使用者列表</a>
        ...
        <div class="d-flex justify-content-center">
          <a name="" id="" class="btn btn-warning me-5" href="user-edit.php?id=<?= $row["id"] ?>" role="button"><i class="fa-solid fa-user-pen fa-fw"></i></a>
          <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#confirmModal">
            <i class="fa-solid fa-user-xmark fa-fw"></i></button>
